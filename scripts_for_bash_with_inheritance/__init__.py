...
DICT_HEADERS_COLUMN_ENG: Dict[Tuple, str] = {
    ...
    ("Номер контейнера", "№контейнера", "№ контейнера", "Container"): "container_number",
    ("Пломба", "№ пломбы", "№пломбы", "№ пломбы "): "container_seal",
    ("Вес брутто (кг)", "Вес груза         брт, кг ", "Вес груза", "Вес груза брт,кг", "Вес груза брт, кг", "Weight",
    ...
    ("Наименование груза", "Наименование заявленного груза", "Наименование заявленного груза (рус)"): "goods_name_rus",
    ("ТНВЭД", "КОД ТНВЭД", "Код Тн ВЭД"): "goods_tnved",
    ...
    ("Страна отправителя", "Страна грузоотправителя", "Страна отправления", "Страна", "Страна порта погрузки",
     "Страна затарки", "Страна погрузки", """Страна 
грузоотправителя"""): "shipper_country",
