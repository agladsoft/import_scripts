...
DICT_HEADERS_COLUMN_ENG: Dict[Tuple, str] = {
    ...
    ("Вес брутто (кг)", "Вес груза         брт, кг ", "Вес груза", "Вес груза брт,кг", "Вес груза брт, кг", "Weight"):
        "goods_weight",
    ("Количество мест", "Кол-во мест", "мест", "Кол-во", "Кол -во мест", "Places"): "package_number",
    ("Наименование груза", "Наименование заявленного груза"): "goods_name_rus",
    ("ТНВЭД", "КОД ТНВЭД"): "goods_tnved",
    ("Отправитель", "Грузоотправитель", "Shipper                               To Order"): "shipper",
    ("Страна отправителя", "Страна грузоотправителя", "Страна отправления", "Страна"): "shipper_country",
