...
DICT_HEADERS_COLUMN_ENG: Dict[Tuple, str] = {
    ...
    ("Наименование груза", "Наименование заявленного груза", "Наименование заявленного груза (рус)", "Груз"):
        "goods_name_rus",
    ("ТНВЭД", "КОД ТНВЭД", "Код Тн ВЭД", """Российский Код ТНВЭД
(10 знаков) """, "Код ТНВЭД"): "goods_tnved",
...
грузоотправителя""", "Отправитель Страна"): "shipper_country",
