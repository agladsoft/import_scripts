...
DICT_HEADERS_COLUMN_ENG: Dict[Tuple, str] = {
    ("№ п/п", "№"): "number_pp",
    ("Статус", "Тип"): "container_size_and_type",
    ("Тип",): "container_type",
    ("Размер",): "container_size",
    ("Номер контейнера", "№контейнера", "№ контейнера"): "container_number",
    ("Пломба", "№ пломбы", "№пломбы"): "container_seal",
    ("Вес брутто (кг)", "Вес груза         брт, кг ", "Вес груза", "Вес груза брт,кг", "Вес груза брт, кг"):
        "goods_weight",
    ("Количество мест", "Кол-во мест", "мест", "Кол-во", "Кол -во мест"): "package_number",
    ...
    ("Коносамент", "№ к/с", "№ Коносамента", "№коносамента"): "consignment",
