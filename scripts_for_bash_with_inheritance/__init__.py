...
DICT_HEADERS_COLUMN_ENG: Dict[Tuple, str] = {
    ...
    ("Страна отправителя", "Страна грузоотправителя", "Страна отправления", "Страна", "Страна порта погрузки",
     "Страна затарки", "Страна погрузки"): "shipper_country",
    ("Получатель", "Грузополучатель", "Consignee       Seal"): "consignee",
    ("Коносамент", "№ к/с", "№ Коносамента", "№коносамента", "Bill of Lading"): "consignment",
