...
xls_path="${XL_IDP_PATH_IMPORT}/lines_${XL_IMPORT_TERMINAL}/cma_cgm/"
#xls_path=/home/timur/Anton_project/import_xls-master/lines_nutep/cma_cgm
...
do
  ...
  if [ $? -eq 0 ]
	...
	exit_message=$(python3 ${XL_IDP_ROOT}/scripts_for_bash_with_inheritance/cma_cgm.py "${csv_name}" "${json_path}" 2>&1 > /dev/null)
