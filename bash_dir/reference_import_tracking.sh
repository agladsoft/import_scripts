...
xls_path="${XL_IDP_ROOT}/reference/reference_import_tracking/"
...
do
  ...
  if [ $? -eq 0 ]
	...
	python3 /mnt/xl_idp_root/scripts_for_bash_with_inheritance/reference_import_tracking.py "${csv_name}" "${json_path}"
