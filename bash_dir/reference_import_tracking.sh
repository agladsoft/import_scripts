...
xls_path="${XL_IDP_PATH_IMPORT}/reference/reference_import_tracking/"
...
do
  ...
  if [ $? -eq 0 ]
	...
	python3 ${XL_IDP_ROOT}/scripts_for_bash_with_inheritance/reference_import_tracking.py "${csv_name}" "${json_path}"
