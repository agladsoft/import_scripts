...
declare -a DirsArray=(
    "flat_import_nutep_tracking"
    "flat_import_nutep_tracking_update"
)

for dir in "${DirsArray[@]}"; do

  xls_path="${XL_IDP_PATH_IMPORT}/lines_${XL_IMPORT_TERMINAL}/${dir}"
  ...
  do
    ...
    python3 ${XL_IDP_ROOT}/scripts/flat_import_nutep.py "${file}" "${json_path}"
