...
xls_path="${XL_IDP_PATH_IMPORT}/lines_${XL_IMPORT_TERMINAL}/fesco/"
#xls_path=/home/timur/Anton_project/import_xls-master/lines_nutep/fesco
...
do
  ...
  if [ $? -eq 0 ]
	...
	python3 ${XL_IDP_ROOT}/scripts_for_bash_with_inheritance/fesco.py "${csv_name}" "${json_path}"
