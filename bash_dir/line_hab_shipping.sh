...
xls_path="${XL_IDP_PATH_IMPORT}/lines_${XL_IMPORT_TERMINAL}/hab_shipping/"
...
do
  ...
  if [ $? -eq 0 ]
	...
	python3 ${XL_IDP_ROOT}/scripts_for_bash_with_inheritance/hab_shipping.py "${csv_name}" "${json_path}"
